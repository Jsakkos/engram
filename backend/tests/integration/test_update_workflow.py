...
def reset_update_checker():
    ...
    saved = {
        ...
        "current_release_notes": update_checker.current_release_notes,
        "current_release_url": update_checker.current_release_url,
        "_current_release_fetched": update_checker._current_release_fetched,

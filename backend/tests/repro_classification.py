...
def test_analyst():
    ...
    titles = [
        TitleInfo(
            index=0, duration_seconds=6420, size_bytes=20000000000, chapter_count=16
        ),  # Main Movie
        TitleInfo(
            index=1, duration_seconds=1200, size_bytes=1000000000, chapter_count=1
        ),  # Extra 20 min
        TitleInfo(
            index=2, duration_seconds=1240, size_bytes=1000000000, chapter_count=1
        ),  # Extra 20 min
        TitleInfo(
            index=3, duration_seconds=1180, size_bytes=1000000000, chapter_count=1
        ),  # Extra 19 min
        TitleInfo(
            index=4, duration_seconds=300, size_bytes=500000000, chapter_count=1
        ),  # Short extra
    ]
